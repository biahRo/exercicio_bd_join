...
/* a */ 
select * from area a join curso b ON a.id_are = b.id_cur;
go

/*Right*/
select * from area a right join curso b ON a.id_are = b.id_cur;
go

/* Left*/
select * from area a left join curso b ON a.id_are = b.id_cur;
go

/* b */ 
select a.id_are,a.nm_are,c.nm_cur,p.nm_prof
...
/* d */ 
select a.id_are,a.nm_are,c.nm_cur,p.nm_prof,m.nm_mat,m.sg_mat
from area a 
